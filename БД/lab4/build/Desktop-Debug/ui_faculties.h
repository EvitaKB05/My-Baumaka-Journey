...
public:
    ...
    void setupUi(QWidget *faculties)
    {
        ...
        faculties->resize(803, 571);
        centralwidget = new QWidget(faculties);
        centralwidget->setObjectName("centralwidget");
        centralwidget->setGeometry(QRect(10, 40, 781, 526));
        ...
        menubar = new QMenuBar(faculties);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(10, 10, 800, 21));
        statusbar = new QStatusBar(faculties);
        statusbar->setObjectName("statusbar");
        statusbar->setGeometry(QRect(10, 10, 3, 22));
    ...
    {
        faculties->setWindowTitle(QCoreApplication::translate("faculties", "Form", nullptr));
        btnConnect->setText(QCoreApplication::translate("faculties", "Connect", nullptr));
        btnSelectAll->setText(QCoreApplication::translate("faculties", "Select All", nullptr));
        lbID->setText(QCoreApplication::translate("faculties", "ID", nullptr));
        lbTitle->setText(QCoreApplication::translate("faculties", "Title", nullptr));
        lbHousing->setText(QCoreApplication::translate("faculties", "Id_housing", nullptr));
        btnAdd->setText(QCoreApplication::translate("faculties", "Add", nullptr));
        btnEdit->setText(QCoreApplication::translate("faculties", "Edit", nullptr));
        btnDel->setText(QCoreApplication::translate("faculties", "Del", nullptr));
    } // retranslateUi
