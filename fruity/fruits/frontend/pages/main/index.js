...
export class MainPage {
    constructor(parent) {
        ...
        this.productsData = JSON.parse(localStorage.getItem('productsData')) || this.getDefaultData();
    }
        ...
        return [
            {
                id: 1,
                title: "Мясо",
                src: "static/images/meat_category.jpg",
                products: [
                    {
                        id: 1,
            ...
            },
            {
                id: 2,
                title: "Овощи",
                src: "static/images/vegetables_category.jpg",
                products: [
                    {
                        id: 4,
            ...
            },
            {
                id: 3,
                title: "Фрукты",
                src: "static/images/fruits_category.jpg",
                products: [
                    {
                        id: 7,
            ...
            },
            {
                ...
                src: "static/images/dairy_category.jpg",
                products: [
                    {
                        id: 10,
    ...
    handleCategoryClick = (category) => {
        ...
        const categoryPage = new CategoryPage(this.parent, category, this);
        categoryPage.render();
    }
    ...
    if (!cartButton) return; // Добавляем проверку
    ...
    renderContent() {
        ...
        if (this.showCategories) {
            ...
            categories.forEach(category => {
                ...
                categoryCard.render(category, () => this.handleCategoryClick(category.title));
            });
        } else {
            ...
            const data = this.getData().find(cat => cat.title === this.currentCategory);
            contentContainer.innerHTML = '';
