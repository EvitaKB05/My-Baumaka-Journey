        ...
        const allProducts = [
            {
                ...
                title: "Говядина",
                text: "Свежая говядина высшего качества. Идеально подходит для стейков и гуляша. 500 руб/кг",
                category: "Мясо",
                price: "500 руб/кг"
            },
            {
                ...
                title: "Баранина",
                text: "Нежная баранина. Отлично подходит для плова и шашлыка. 600 руб/кг",
                category: "Мясо",
                price: "600 руб/кг"
            },
            {
                ...
                title: "Курица",
                text: "Куриные грудки. Диетический продукт с высоким содержанием белка. 300 руб/кг",
                category: "Мясо",
                price: "300 руб/кг"
            },
            {
                ...
                title: "Морковь",
                text: "Свежая морковь. Богата витамином А и клетчаткой. 50 руб/кг",
                category: "Овощи",
                price: "50 руб/кг"
            },
            {
                id: 5,
                src: "static/images/cucumbers.jpg",
                title: "Огурцы",
                text: "Спелые огурцы. Самые важные компоненты любого салата. 50 руб/кг",
                category: "Овощи",
            ...
            },
            {
                ...
                title: "Помидоры",
                text: "Сочные помидоры. Содержат ликопин - мощный антиоксидант. 150 руб/кг",
                category: "Овощи",
                price: "150 руб/кг"
            },
            {
                ...
                title: "Апельсины",
                text: "Сладкие апельсины. Богаты витамином С. 120 руб/кг",
                category: "Фрукты",
                price: "120 руб/кг"
            },
            {
                ...
                title: "Бананы",
                text: "Спелые бананы. Отличный источник калия и энергии. 80 руб/кг",
                category: "Фрукты",
                price: "80 руб/кг"
            },
            {
                ...
                title: "Яблоки",
                text: "Красные яблоки. Содержат пектин и множество витаминов. 90 руб/кг",
                category: "Фрукты",
                price: "90 руб/кг"
            },
            {
                ...
                title: "Молоко 3,2 %",
                text: "Полезный и природный продукт. 100 руб/л",
            ...
            },
            {
                ...
                text: "Любимец мышек и британцев. 200 руб/100 г",
                category: "Молочные Продукты",
                price: "200 руб/100 г"
            },
            {
                ...
                text: "Очень нужный товарищ для вкусняшек. 250 руб/100 г",
                category: "Молочные Продукты",
                price: "250 руб/100 г"
            }
        ];
